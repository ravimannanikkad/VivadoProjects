...
HD_PWD='C:/Users/ravim/OneDrive/Desktop/VivadoProjects/MB_Sensor/MB_Sensor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MB_Sensor_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MB_Sensor_wrapper.tcl -notrace
