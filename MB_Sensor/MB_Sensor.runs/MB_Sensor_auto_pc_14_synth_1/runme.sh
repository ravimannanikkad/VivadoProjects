...
HD_PWD='C:/Users/ravim/OneDrive/Desktop/VivadoProjects/MB_Sensor/MB_Sensor.runs/MB_Sensor_auto_pc_14_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MB_Sensor_auto_pc_14.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MB_Sensor_auto_pc_14.tcl
