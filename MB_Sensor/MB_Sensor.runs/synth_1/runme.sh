...
HD_PWD='C:/Users/ravim/OneDrive/Desktop/VivadoProjects/MB_Sensor/MB_Sensor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MB_Sensor_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MB_Sensor_wrapper.tcl
