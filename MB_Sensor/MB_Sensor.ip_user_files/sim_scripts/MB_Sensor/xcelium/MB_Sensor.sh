...
execute()
{
  xrun $xrun_opts \
       ...
       -top xil_defaultlib.MB_Sensor \
       -f run.f \
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../MB_Sensor.srcs/sources_1/bd/MB_Sensor/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../MB_Sensor.srcs/sources_1/bd/MB_Sensor/ipshared/2d50/hdl" \
       +incdir+"../../../../MB_Sensor.srcs/sources_1/bd/MB_Sensor/ipshared/ec67/hdl" \
       +incdir+"../../../../MB_Sensor.srcs/sources_1/bd/MB_Sensor/ipshared/2d50/hdl" \
       +incdir+"../../../../MB_Sensor.srcs/sources_1/bd/MB_Sensor/ip/MB_Sensor_processing_system7_0_0" \
